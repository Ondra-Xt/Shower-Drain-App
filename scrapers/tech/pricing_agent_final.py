    ...
    def run(self):
        ...
        with sync_playwright() as p:
            ...
            for task in tasks:
                ...
                # ZMĚNA: Povolíme Hornbach i Megabad pro všechny, abychom měli srovnání
                shops = ["Hornbach", "Megabad"]
                # if brand in ["Geberit", "TECE"]: shops = ["Megabad"] # ZAKOMENTOVÁNO
                
                found_anywhere = False
                for shop in shops:
                    # Malá pauza mezi obchody
                    ...
                    if self.search_manual(page, shop, query):
                        ...
                        if p_val:
                            ...
                            found_anywhere = True
                            # ZMĚNA: Break odstraněn, aby hledal dál na druhém shopu
                
                if not found_anywhere: print(f"❌ Nenalezeno nikde: {brand} {sku}")
