            ...
            try:
                ...
                if not str(df_tech.at[idx, 'Datasheet_URL']).startswith('http'):
                    ...
                    if pdf_tag:
                        ...
                        df_tech.at[idx, 'Datasheet_URL'] = str(pdf_url)
        ...
        if updates_made > 0 or market_prices:
            ...
            with pd.ExcelWriter(self.excel_path, engine='openpyxl', mode='a', if_sheet_exists='replace') as writer:
                ...
                try:
                    ...
                    # Fix typů i pro staré ceny
                    df_old_prices['Component_SKU'] = df_old_prices['Component_SKU'].astype(str)
                    
                    df_new_prices = pd.DataFrame(market_prices)
                    df_new_prices['Component_SKU'] = df_new_prices['Component_SKU'].astype(str)
